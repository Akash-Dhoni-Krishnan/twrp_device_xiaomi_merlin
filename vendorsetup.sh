...
if [ "$1" = "$FDEVICE" -o "$FOX_BUILD_DEVICE" = "$FDEVICE" ]; then
 ...
 export OF_QUICK_BACKUP_LIST="/boot;/persist_image;"
 ...
 export OF_RUN_POST_FORMAT_PROCESS=1 # Unencrpyted only
 ...
 export OF_CLOCK_POS=0 # Left, Center & Right
