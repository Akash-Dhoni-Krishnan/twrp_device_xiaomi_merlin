...
# Kernel
TARGET_PREBUILT_KERNEL := $(DEVICE_PATH)/prebuilt/merlinx-kernel.zip
BOARD_KERNEL_CMDLINE := bootopt=64S3,32N2,64N2 androidboot.selinux=permissive
BOARD_KERNEL_IMAGE_NAME := merlinx-kernel.zip
...
# Image
BOARD_PREBUILT_DTBIMAGE_DIR := $(DEVICE_PATH)/prebuilt/old_dtb
TARGET_PREBUILT_DTBIMAGE := $(DEVICE_PATH)/prebuilt/dtb/mt6768.dtb
...
BOARD_USERDATAIMAGE_PARTITION_FSTYPE := f2fs
BOARD_USES_GENERIC_LIBUTIL := true
TW_USE_F2FS_UTILS := true
